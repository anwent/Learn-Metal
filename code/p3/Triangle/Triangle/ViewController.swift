...
extension ViewController {
    ...
    private func p3_createVertexBuffer() {
        ...
        let mat = Matrix()
            .scalingMatrix(0.5)
            .translationMatrix(vector_float3(0.5, 0.5, 1.0))
        ...
        // ???
//        uniformBuffer = device?.makeBuffer(bytes: Matrix().modelMatrix(Matrix()).m, length: MemoryLayout<Float>.size * 16, options: [])
